...
message(STATUS "sensors: 0 messages, 1 services")
...
get_filename_component(_filename "/home/daniel/Documents/Senior-Project/catkin_ws/src/sensors/srv/RegistrationService.srv" NAME_WE)
add_custom_target(_sensors_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "sensors" "/home/daniel/Documents/Senior-Project/catkin_ws/src/sensors/srv/RegistrationService.srv" ""
)
...
_generate_srv_cpp(sensors
  "/home/daniel/Documents/Senior-Project/catkin_ws/src/sensors/srv/RegistrationService.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sensors)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/sensors/.+/__init__.pyc?$"
  )
endif()
