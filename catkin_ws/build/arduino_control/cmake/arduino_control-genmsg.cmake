...
set(MSG_I_FLAGS "-Iarduino_control:/home/daniel/Documents/Senior-Project/catkin_ws/src/arduino_control/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/daniel/Documents/Senior-Project/catkin_ws/src/arduino_control/msg/ArduinoControl.msg" NAME_WE)
add_custom_target(_arduino_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arduino_control" "/home/daniel/Documents/Senior-Project/catkin_ws/src/arduino_control/msg/ArduinoControl.msg" ""
)
...
_generate_msg_cpp(arduino_control
  "/home/daniel/Documents/Senior-Project/catkin_ws/src/arduino_control/msg/ArduinoControl.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arduino_control)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arduino_control\")")
  # install generated code
  install(
